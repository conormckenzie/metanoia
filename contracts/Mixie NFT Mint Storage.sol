...
//     event alternateUriChanged(address indexed msgSender, uint indexed id); 
//        // ^ old and new uri is supposed to be hidden
...
//     */
//     function mintNextNftToAddress(address to) 
//     external isNewMint(nextUnusedToken, 1, to) whenNotPaused nonReentrant {
